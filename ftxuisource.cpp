...
ScreenInteractive::ScreenInteractive(Dimension dimension, int dimx, int dimy,
...
bool ScreenInteractive::HasQuitted() { return quit_; }
...
// private:
void ScreenInteractive::ExitNow() { quit_ = true; }
